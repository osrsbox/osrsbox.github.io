...
function clear_display_offsets() {
  ...
  var i = 0;
  for (i; i < locations.length; i++) {
    document.getElementById("spawn-" + locations[i] + "-offset").src =
      "images/empty.png";
...
function wave1(location) {
  ...
  document.getElementById("text-line").innerHTML =
    "<b>WAVE 2:</b> <br> Where did the next two level 22s spawn?";
}
...
function wave2b(location) {
  ...
  if (
    spawns_from_user.charAt(0) == "s" &&
    ((spawns_from_user.charAt(2) == "c" && spawns_from_user.charAt(4) == "n") ||
      (spawns_from_user.charAt(2) == "n" && spawns_from_user.charAt(5) == "c"))
  ) {
    ...
    // Update the text-line to display next prompt for user
    document.getElementById("text-line").innerHTML =
      "<b>WAVE 3/4:</b> <br> Where did the second level 45 spawn?";
  } else {
...
function check_spawns() {
  ...
  if (spawns_from_user in possible_spawns) {
    ...
    document.getElementById("text-line").innerHTML =
      "ERROR: Locations do not match database. Refresh";
  }
}
...
function display_wave(wave_number) {
  ...
  document.getElementById("wave-text-line").textContent =
  ...
  for (i; i < mobs.length; i++) {
    ...
    if (plotted[location]) {
      document.getElementById("spawn-" + location + "-offset").src =
        "images/" + level + ".png";
      document.getElementById("spawn-" + location + "-offset").style =
        "width:100px;height:92px;";
    } else {
      plotted[location] = true;
      document.getElementById("spawn-" + location).src =
        "images/" + level + ".png";
    }
  }
  ...
  if (previous_mobs.indexOf("360") != -1 && previous_mobs.indexOf("90") != -1) {
    document.getElementById("prayer-previous").src =
      "images/prayer-rangedmagic.png";
  ...
  if (current_mobs.indexOf("360") != -1 && current_mobs.indexOf("90") != -1) {
    document.getElementById("prayer-current").src =
      "images/prayer-rangedmagic.png";
  ...
  if (next_mobs.indexOf("360") != -1 && next_mobs.indexOf("90") != -1) {
    document.getElementById("prayer-next").src =
      "images/prayer-rangedmagic.png";
