// Fetch summary.json on page load
// Then generate osrs-items table
$.getJSON("https://www.osrsbox.com/osrsbox-db/summary.json", function(data) {
...
{
    console.log("called")
$('td:eq(0)', nRow).html( "<img src='https://www.osrsbox.com/osrsbox-db/items-icons/" + aData["id"] + ".png'></img>" );
return nRow;
}