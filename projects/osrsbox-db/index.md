---
layout: project
title: OSRSBOX | A complete and up-to-date database of Old School Runescape (OSRS) items, monsters and prayers
project_name: OSRSBox Database
project_desc: A complete and up-to-date database of Old School Runescape (OSRS) items, monsters and prayers available via a Python package, JSON API, and RESTful API.
